...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `NeonGamerBot-QK`, `wplace-but-slack`, `twitter_handle`, `linkedin_username`, `project_title`, `project_description`
...
See the [open issues](https://github.com/NeonGamerBot-QK/wplace-but-slack/issues) for a full list of proposed features (and known issues).
